...
úhlů získáme $\gamma = "180\dg" - "118\dg" = "62\dg"$. Pomocí souhlasných
a středových úhlů máme $\alpha = "48\dg"$. Ze součtu vnitřních úhlů trojúhelníku
(součet je vždy roven $"180\dg"$) zjistíme $\beta = "180\dg" - \("62\dg" + "48\dg"\) = "70\dg"$.
Dále si všimneme Thaletovy kružnice, z níž vyplývá, že trojúhelník $\bod{ABC}$
je pravoúhlý. Odtud nám vychází $\alpha = "180\dg" - \("90\dg" + \beta\) = "20\dg"$.
}%
